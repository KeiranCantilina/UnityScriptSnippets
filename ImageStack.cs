...
namespace DICOMParser
{
    ...
    public class ImageStack : MonoBehaviour
    {
        ...
        public ThreadGroupState StartCreatingTextures()
        {
            ...
            StartCoroutine(CreateTextures(state));// Modified by KKC                                                  --------------------------------------------------------------------
        ...
        public Texture2D GetTexture2D(SliceType type, int index)
        {
            switch (type)
            {
                case SliceType.Transversal:
                    ...
                    {
                        DebugText.text = "Texture: Transversal texture is null, whoops;";
                        return null;
                    }
                ...
                case SliceType.Frontal:
                    ...
                    {
                        DebugText.text = "Texture: Frontal texture is null, whoops;";
                        return null;
                    };
                case SliceType.Sagittal:
                    ...
                    {
                        DebugText.text = "Texture: Sagittal texture is null, whoops;";
                        return null;
                    };
                default:
