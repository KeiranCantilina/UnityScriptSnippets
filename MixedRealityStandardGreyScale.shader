...
Shader "Mixed Reality Toolkit/StandardGreyscale"
{
    Properties
    {
        // Main maps.
...
#define PROXIMITY_LIGHT_DATA_SIZE 6
            ...
            // Texturing.
                ...
                albedo *= 0.25;
#else
                // Copies red channel data into the green and blue channels and sets a channel to 1
                float texcol = tex2D(_MainTex, i.uv).r;
                fixed4 albedo = fixed4(texcol, texcol, texcol, 1.0f);
                //fixed4 albedo = tex2D(_MainTex, i.uv); // from original standard shader
#endif
#endif
#endif
