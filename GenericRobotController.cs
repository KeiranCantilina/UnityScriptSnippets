...
{
    [AddComponentMenu("Keiran Utils/GenericRobotController")]
    public class GenericRobotController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            // Create dummy object to hold target cartesian transform
            GameObject dummyObject = new GameObject("Dummy Object");
            dummyObject.tag = "Ignore";
            targetCartesian = dummyObject.transform;
        }
        ...
        void Update()
        {
            if (moveRobot)
            {
                ...
                newAngles = KeiranUtils.GenericIKCalculator.RunIK(targetCartesian, InverseKinematicsTarget, joints, axisDirections, oldAngles);
        ...
        public void MoveRobot(Vector3 targetPos, Vector3 targetRot, GameObject targetObject)
        {
            InverseKinematicsTarget = targetObject;
