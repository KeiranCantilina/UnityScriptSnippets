...
namespace DICOMParser
{
    ...
    public sealed class DiDictonary
    {
        ...
        private DiDictonary()
        {
            ...
            MediaStorageMap.Add("1.2.840.10008.5.1.4.1.1.2", "CT Image Storage"); // KKC Sample data is this one
            ...
            DataElementMap.Add(0x00120062, new TagMetaData(VRType.CS, "Patient Identity Removed")); // Added by KKC
            DataElementMap.Add(0x00120063, new TagMetaData(VRType.LO, "De-identification Method")); // Added by KKC
            DataElementMap.Add(0x00120064, new TagMetaData(VRType.SQ, "De-identification Method Code Sequence")); // Added by KKC
            ...
            DataElementMap.Add(0x00189305, new TagMetaData(VRType.FD, "Revolution Time")); // Added by KKC
            DataElementMap.Add(0x00189306, new TagMetaData(VRType.FD, "Single Collimation Width")); // Added by KKC
            DataElementMap.Add(0x00189307, new TagMetaData(VRType.FD, "Total Collimation Width")); // Added by KKC
            DataElementMap.Add(0x00189309, new TagMetaData(VRType.FD, "Table Speed")); // Added by KKC
            DataElementMap.Add(0x00189310, new TagMetaData(VRType.FD, "Table Feed per Rotation")); // Added by KKC
            DataElementMap.Add(0x00189311, new TagMetaData(VRType.FD, "Spiral Pitch Factor")); // Added by KKC
            ...
            DataElementMap.Add(0x00200062, new TagMetaData(VRType.CS, "Image Laterality")); // Added by KKC
